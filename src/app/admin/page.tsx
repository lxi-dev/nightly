...
import ProfilePictureGenerator from 'nglty/components/elements/forms/fields/profile-picture';
...
export default async function Page() {
    ...
    return (
            <HydrateClient>
                <div className="min-h-screen flex flex-col items-center justify-between gap-4">
