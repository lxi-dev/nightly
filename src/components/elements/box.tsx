...
export const bentoClass = "flex flex-col h-full dark:text-white dark:bg-aurora border xl:border-2 border-gray-300 dark:border-gray-700 shadow-lg rounded-2xl"
